...
/**
 * Class Newspaperup_Customizer_Range_Control
 *
 * @access public
 */
class Newspaperup_Customizer_Range_Control extends WP_Customize_Control {
 ...
 */
function newspaperup_sanitize_range_value( $input ) {
	if ( newspaperup_is_json( $input ) ) {
 ...
 * @param  string $string Input.
 */
function newspaperup_is_json( $string ) {
	return is_string( $string ) && is_array( json_decode( $string, true ) ) ? true : false;
}
